...
*/
        ...
        Job myJob = dispatcher.newJobBuilder()
                ...
                .setTrigger(Trigger.executionWindow(secondsUntilMidnight, secondsUntilMidnight + 6000))
    ...
    public static void scheduleOverdueTaskNotificationService(Context context){
        ...
        Job myJob = dispatcher.newJobBuilder()
                ...
                .setRecurring(false)
                .setLifetime(Lifetime.FOREVER).setTrigger(Trigger.executionWindow(0, 60))
                //.setTrigger(Trigger.executionWindow(secondsUntilMidnight, secondsUntilMidnight+300))
                .setReplaceCurrent(false)
                .setRetryStrategy(RetryStrategy.DEFAULT_EXPONENTIAL)
                .build();
